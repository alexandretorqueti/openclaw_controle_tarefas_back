  ...
  static handler() {
    return async (error, req, res, next) => {
      try {
        ...
        const logEntry = await Logger.logError(error, req, res, errorType, req.correlationId);
