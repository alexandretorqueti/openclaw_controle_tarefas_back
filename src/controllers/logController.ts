...
class LogController {
  // Get monitor logs
  getMonitorLogs = ErrorMiddleware.catchAsync(async (req, res, next): Promise<any> => {
    try {
  ...
  getErrorLogs = ErrorMiddleware.catchAsync(async (req, res, next): Promise<any> => {
    try {
  ...
  getAllLogs = ErrorMiddleware.catchAsync(async (req, res, next): Promise<any> => {
    try {
      const {
        level,
        endpoint,
