...
const projectRoutes = require('./routes/projectRoutes');import taskRoutes from './routes/taskRoutes');
...
const ErrorMiddleware = require('./middlewares/errorMiddleware');import { Logger }, import { LOG_LEVELS } from './utils/logger');
...
const corsOptions = {
  ...
  origin: function(origin, callback) {
    ...
    const allowedOrigins = process.env.CORS_ORIGIN 
      ...
      : ['http://localhost:3000', 'http://192.168.0.70:3000'];
...
app.post('/api/test/terminal-update', (req, res) => {
  try {
    ...
    // Emitir evento SSEimport sseService from './services/sseService';
...
// Importar serviço SSEimport sseService from './services/sseService');
