 ...
 */
function createLegacyGetNextTask(defaultApiUrl = null): any {
  // Importar GetNextTaskStep (evita circular dependency)
  import GetNextTaskStep from '../GetNextTaskStep';
   ...
   */
  return async function getNextEligibleTask(nickname: any): any {
    try {
...
export { createLegacyGetNextTask };

export default { createLegacyGetNextTask };