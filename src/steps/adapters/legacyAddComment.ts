 ...
 */
function createLegacyAddComment(defaultUserId = null): any {
   ...
   */
  return async function addComment(taskId: any, content: any): any {
    try {
 ...
 */
async function addComment(taskId: any, content: any, userId = null): any {
  try {
...
export { createLegacyAddComment, addComment };

export default { createLegacyAddComment, addComment };