 ...
 */
async function fileExists(pathToCheck: any): Promise<any> {
  try {
 ...
 * @returns {boolean}
 */
function fileExistsSync(pathToCheck: any): any {
 ...
 */
async function safeReadFile(filePath: any, encoding: any = 'utf8'): any {
  try {
 ...
 * @returns {Promise<boolean>}
 */
async function safeWriteFile(filePath: any, content: any, encoding: any = 'utf8'): any {
  try {
 ...
 * @returns {Promise<boolean>}
 */
async function safeUnlink(filePath: any): any {
  try {
 ...
 * @returns {Promise<boolean>}
 */
async function safeMoveFile(sourcePath: any, destPath: any): any {
  try {
 ...
 * @returns {Object}
 */
function fingerprintFileSync(filePath: any): any {
  try {
 ...
 * @returns {Promise<Object>}
 */
async function collectFingerprints(files: any = []): any {
  const result = {};
 ...
 */
function diffFingerprints(before: any = {}, after: any = {}): any {
 ...
 * @returns {boolean}
 */
function didFingerprintChange(before: any = {}, after: any = {}): any {
 ...
 * @returns {string}
 */
function truncateOutput(text: any, max: any = 20000): any {
 ...
 * @returns {boolean}
 */
function isEphemeralArtifact(filePath: any): any {
