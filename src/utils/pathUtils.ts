 ...
 * @returns {string[]}
 */
function uniquePaths(values = []): any {
  return Array.from(
    new Set(
      (values || [])
        .filter(Boolean)
 ...
 * @returns {string[]}
 */
function mergeUniquePaths(current = [], incoming = []): any {
 ...
 * @returns {string|null}
 */
function resolveProjectPath(basePath: any, subPath: any): any {
 ...
 * @returns {boolean}
 */
function isPathInside(targetPath: any, basePath: any): any {
 ...
 * @returns {string}
 */
function resolveFilePath(filePath: any, cwd: any): any {
 ...
 * @returns {string[]}
 */
function extractPathTokensFromCommand(command: any): any {
