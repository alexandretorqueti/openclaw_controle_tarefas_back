...
class SessionChainUtils {
     ...
     */
    static findFirstTaskInChain(taskId) {
     ...
     */
    static generateUnifiedSessionId(taskId, sessionType, turnNumber = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const firstTaskId = yield this.findFirstTaskInChain(taskId);
     ...
     */
    static hasPendingDependencies(taskId) {
        return __awaiter(this, void 0, void 0, function* () {
            const dependencies = yield prisma.dependency.findMany({
                where: {
            ...
            return dependencies.some(dep => dep.task && dep.task.status && !dep.task.status.isFinalState);
        });
    }
    /**
