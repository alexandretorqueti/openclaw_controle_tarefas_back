...
class UserResolver {
   ...
   */
  static async resolveUser({ nickname, userId, defaultNickname = null }): Promise<any> {
    try {
   ...
   * @returns {Promise<Object|null>} Usuário encontrado ou null
   */
  static async resolveUserFromRequest(req): Promise<any> {
   ...
   */
  static async getDefaultUserId(): Promise<any> {
    try {
