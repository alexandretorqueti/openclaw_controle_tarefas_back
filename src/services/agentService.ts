 ...
 */
export const execOpenClawCommand = async (command, args = []): Promise<any> => {
 ...
 */
export const _fetchAgentsDirectly = async (): Promise<any> => {
  try {
 ...
 */
export const addAgent = async (name, workspace): Promise<any> => {
  try {
    const args = ['add', name];
    if (workspace) {
 ...
 */
export const setAgentIdentity = async (agentId, identity): Promise<any> => {
  try {
 ...
 * @returns {Promise<Object>} - Resultado da operação
 */
export const bindAgent = async (agentId, binding): Promise<any> => {
  try {
 ...
 * @returns {Promise<Object>} - Resultado da operação
 */
export const unbindAgent = async (agentId, binding): Promise<any> => {
  try {
    const result = await exports.execOpenClawCommand('agents', [
      'unbind',
      '--agent', agentId,
 ...
 * @returns {Promise<Object>} - Resultado da operação
 */
export const deleteAgent = async (agentId): Promise<any> => {
  try {
 ...
 */
export const getAgentDetails = async (agentId): Promise<any> => {
  try {
 ...
 */
export const agentExists = async (agentId): Promise<any> => {
  try {
    const agents = await exports.listAgents();
 ...
 * @param {string} agentId - ID do agente
 * @param {string} __filename - Nome do arquivo (IDENTITY.md ou SOUL.md)
 * @returns {Promise<string>} - Conteúdo do arquivo
 */
export const readAgentFile = async (agentId, __filename): Promise<any> => {
  try {
    ...
    const filePath = path.join(workspace, __filename);
    ...
    console.error(`Erro ao ler arquivo ${__filename} do agente ${agentId}:`, error.message);
 ...
 * @returns {Promise<Object>} - Resultado da operação
 */
export const writeAgentFile = async (agentId, __filename, content): Promise<any> => {
  try {
    // Primeiro verificar se o agente existe
    const exists = await exports.agentExists(agentId);
    if (!exists) {
    ...
    console.error(`Erro ao escrever no arquivo ${__filename} do agente ${agentId}:`, error.message);
    throw error;
  }
};
// Adicionar export default no final
const agentService = {
  execOpenClawCommand,
  _fetchAgentsDirectly,
  listAgents,
  addAgent,
  setAgentIdentity,
  bindAgent,
