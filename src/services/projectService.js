...
class ProjectService {
    ...
    getAllProjects(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return projects.map(project => {
                ...
                const overdueTasks = tasks.filter(t => !t.isCompleted && new Date(t.deadline) < new Date()).length;
                const progress = totalTasks > 0 ? Math.round((completedTasks / totalTasks) * 100) : 0;
                return Object.assign(Object.assign({}, project), { statistics: {
                        totalTasks,
                        completedTasks,
                        overdueTasks,
                        progress
    ...
    updateProject(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (data.frontendPath !== undefined)
                updateData.frontendPath = data.frontendPath || null;
            if (data.frontendPort !== undefined)
                updateData.frontendPort = data.frontendPort || null;
            if (data.backendPath !== undefined)
                updateData.backendPath = data.backendPath || null;
            if (data.backendPort !== undefined)
                updateData.backendPort = data.backendPort || null;
            if (data.repositoryUrl !== undefined)
                updateData.repositoryUrl = data.repositoryUrl || null;
            if (data.pastaBase !== undefined)
                updateData.pastaBase = data.pastaBase || null;
            if (data.agent !== undefined)
                updateData.agent = data.agent || null;
            if (data.programadorFront !== undefined)
                updateData.programadorFront = data.programadorFront || null;
            if (data.programadorFront !== undefined)
                updateData.programadorFront = data.programadorFront || null;
            if (data.programadorBack !== undefined)
                updateData.programadorBack = data.programadorBack || null;
            if (data.modeloAuxiliar !== undefined)
                updateData.modeloAuxiliar = data.modeloAuxiliar || null;
            if (data.frontendBuildCmd !== undefined)
                updateData.frontendBuildCmd = data.frontendBuildCmd || null;
            if (data.backendBuildCmd !== undefined)
                updateData.backendBuildCmd = data.backendBuildCmd || null;
    ...
    deleteProject(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const relatedTasks = yield prisma.task.findMany({
                    where: {
                        projectId: id,
                ...
                const deletedProject = yield prisma.project.update({
                    where: { id },
                    data: {
                        ativo: false,
                        status: false,
