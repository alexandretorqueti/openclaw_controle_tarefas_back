...
class NotificationService {
   ...
   */
  static async sendTelegramNotification(message, chatId = null) {
    try {
   ...
   * @returns {Promise<boolean>} true se enviado com sucesso
   */
  static async sendTelegramNotificationFallback(message, chatId = null) {
    try {
   ...
   */
  static async sendTaskCompletedNotification(task, user, executionNotes = null) {
    try {
      if (!task || !user) {
   ...
   * @returns {Promise<boolean>} true se notificação enviada
   */
  static async sendParentTaskAutoCompletedNotification(parentTask, completedSubtasks) {
    try {
