...
class EvidenceService {
    ...
    static applyExecutionEvidence(executionEvidence, toolCall, toolResult = {}, options = {}) {
        ...
        const toolName = typeof toolCall === 'string' ? toolCall : toolCall === null || toolCall === void 0 ? void 0 : toolCall.name;
        ...
        if (toolName === 'exec') {
            ...
            if ((_a = toolResult.executionDiagnostics) === null || _a === void 0 ? void 0 : _a.noOpMutation) {
                executionEvidence.noOpMutations = [
                    ...(executionEvidence.noOpMutations || []),
                    {
                        command: ((_b = toolResult.commandsExecuted) === null || _b === void 0 ? void 0 : _b[0]) || (toolCall && toolCall.arguments ? toolCall.arguments.command : null),
    ...
    static computeTurnProgress(toolResult = {}, contractResult = {}, cwd = process.cwd()) {
        ...
        const noOpMutation = !!((_a = toolResult.executionDiagnostics) === null || _a === void 0 ? void 0 : _a.noOpMutation);
        ...
        const hasMeaningfulProgress = contractFulfilled || // Se cumpriu o contrato, é progresso AUTOMATICO!
            (!noOpMutation &&
