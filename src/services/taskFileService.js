...
class TaskFileService {
     ...
     */
    moveTaskFiles(taskId, sourceDir, destinationDir) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Garantir que o diretorio de destino existe
                yield fs.mkdir(destinationDir, { recursive: true });
                // Listar todos os arquivos no diretorio de origem
                const allFiles = yield fs.readdir(sourceDir);
     ...
     */
    prepareTaskFiles(task, tasksDir, project = null, analysisPlan = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield safeWriteFile(paths.promptFile, promptContent);
            yield safeWriteFile(paths.relatorioFile, '');
            yield safeWriteFile(paths.terminalLogFile, '');
            return Object.assign(Object.assign({}, paths), { promptContent, analysisPlan: resolvedAnalysisPlan });
        });
    }
    /**
    ...
    generatePromptContent(task, project, analysisPlan, paths) {
        ...
        const dirBase = (project === null || project === void 0 ? void 0 : project.pastaBase) || 'Diretorio atual';
        const dirFront = (project === null || project === void 0 ? void 0 : project.frontendPath) || 'Nao definido';
        const dirBack = (project === null || project === void 0 ? void 0 : project.backendPath) || 'Nao definido';
...
`;
        ...
        const projectSpecificRules = (project === null || project === void 0 ? void 0 : project.regras)
            ? project.regras
    ...
    cleanupFiles(files) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield fs.mkdir(processedDir, { recursive: true });
                ...
                for (const file of filesToMove) {
                    try {
                        ...
                        yield fs.rename(file, path.join(processedDir, newFileName));
                    }
                    catch (error) {
