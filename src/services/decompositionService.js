...
class DecompositionService {
     ...
     */
    decompose(parentTaskId, subtasksArray) {
            ...
            try {
                ...
                const result = yield prisma.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    for (let i = 0; i < subtasksArray.length; i++) {
                        const subtask = subtasksArray[i];
                        // Criar subtarefa
                        const created = yield tx.task.create({
                            data: {
                                title: subtask.title,
                ...
                try {
                    ...
                    const parentTaskWithSubtasks = yield prisma.task.findUnique({
                        where: { id: parentTaskId },
                        include: {
                            project: {
