...
class LockService {
     ...
     */
    checkLock(timeoutThresholdMs = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield fileExists(this.lockFilePath))) {
                return { locked: false, pid: null };
            }
            try {
                const stat = yield fs.stat(this.lockFilePath);
                const mtime = stat.mtimeMs;
                const age = Date.now() - mtime;
                const pidRaw = yield fs.readFile(this.lockFilePath, 'utf8');
                ...
                const alive = yield this.isProcessAlive(pid);
     ...
     * @returns {Promise<boolean>}
     */
    acquireLock(taskId = null) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Armazenar taskId para uso posterior
                this.currentTaskId = taskId;
                // Criar arquivo de lock
                yield fs.writeFile(this.lockFilePath, process.pid.toString());
                ...
                if (taskId) {
                    try {
                        ...
                        const updated = yield taskService.updateTask(taskId, { isExecuting: true });
    ...
    releaseLock() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (yield fileExists(this.lockFilePath)) {
                    yield fs.unlink(this.lockFilePath);
                    lockReleased = true;
                }
                ...
                if (this.currentTaskId) {
                    try {
                        ...
                        yield taskService.updateTask(this.currentTaskId, { isExecuting: false });
    ...
    forceReleaseLock() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Remover arquivo de lock
                yield fs.unlink(this.lockFilePath).catch(() => { });
                // Se temos um taskId, marcar a tarefa como isExecuting: false
                if (this.currentTaskId) {
                    try {
                        // O updateTask já lida com a hierarquia e os eventos SSE
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (pid) {
                    ...
                    const stillAlive = yield this.isProcessAlive(pid);
                    if (stillAlive) {
            ...
            return yield this.forceReleaseLock();
        });
    }
}
