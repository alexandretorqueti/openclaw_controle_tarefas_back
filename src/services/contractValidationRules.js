        ...
        },
        {
            ...
            getError: (ctx) => {
                ...
                return ({
                    ...
                    feedbackToAgent: `[FALHA DE ARQUITETURA] A análise exige alteração REAL no Frontend, mas você só alterou arquivos de outras pastas. Você ainda não tocou em: ${((_a = ctx.project) === null || _a === void 0 ? void 0 : _a.frontendPath) || ctx.fullFrontendPath}. PROIBIDO concluir a tarefa agora. Vá até essa pasta, faça as alterações necessárias nas telas/componentes, e recrie o .done.`
                });
            }
        },
        {
            ...
            getError: (ctx) => {
                ...
                return ({
                    ...
                    feedbackToAgent: `[FALHA DE ARQUITETURA] A análise exige alteração REAL no Backend, mas você só alterou arquivos de outras pastas. Você ainda não tocou em: ${((_a = ctx.project) === null || _a === void 0 ? void 0 : _a.backendPath) || ctx.fullBackendPath}. PROIBIDO concluir a tarefa agora. Vá até essa pasta, faça as implementações necessárias, e recrie o .done.`
                });
            }
        },
        {
            ...
            getError: (ctx) => {
                ...
                return ({
                    ...
                    feedbackToAgent: `[VALIDACAO] A pre-analise indicou impacto potencial no frontend. Ainda nao ha evidencia de inspecao em ${((_a = ctx.project) === null || _a === void 0 ? void 0 : _a.frontendPath) || ctx.fullFrontendPath}. Revise essa camada antes de concluir.`
                });
            }
        },
        {
            ...
            getError: (ctx) => {
                ...
                return ({
                    ...
                    feedbackToAgent: `[VALIDACAO] A pre-analise indicou impacto potencial no backend. Ainda nao ha evidencia de inspecao em ${((_a = ctx.project) === null || _a === void 0 ? void 0 : _a.backendPath) || ctx.fullBackendPath}. Revise essa camada antes de concluir.`
                });
            }
        }
    ],
