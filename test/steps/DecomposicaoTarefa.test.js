...
const DecomposicaoTarefa_1 = require("../../src/steps/DecomposicaoTarefa");
const legacyCallAnalyst_1 = require("../../src/steps/adapters/legacyCallAnalyst");
...
describe('Passo: Decomposição de Tarefa', () => {
    ...
    it('não deve fazer nada se não houver tarefaAtual no contexto', async () => {
        ...
        expect(legacyCallAnalyst_1.createLegacyCallAnalyst).not.toHaveBeenCalled();
    });
});
afterAll(() => {
