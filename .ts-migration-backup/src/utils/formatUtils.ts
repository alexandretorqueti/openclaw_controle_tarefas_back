 ...
 * @returns {string}
 */
function formatNumberedList(items: any, emptyFallback: any = 'Nenhum item definido.'): any {
 ...
 * @returns {string}
 */
function formatInlineList(items: any, emptyFallback: any = 'nenhum'): any {
 ...
 */
function printDebugBlock(title: any, data: any): any {
  console.log(`\n================ [DEBUG][${title}] ================`);
